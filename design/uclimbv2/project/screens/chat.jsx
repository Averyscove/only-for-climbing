      ...
      <div style={{ position: 'absolute', inset: 0, padding: '60px 22px 40px', display: 'flex', flexDirection: 'column' }}>
        <div style={{ flex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <AFCMark size={40} color={UC.ink} />
            <div style={{ fontFamily: UC.display, fontWeight: 900, fontSize: 28, letterSpacing: -1, lineHeight: 0.95 }}>ALL FOR<br/>CLIMBING<span style={{ color: UC.accent }}>.</span></div>
          </div>

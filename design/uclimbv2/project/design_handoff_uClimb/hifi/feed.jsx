  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 16px 12px' }}>
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
        <span style={{ fontFamily: HF.display, fontSize: 24, letterSpacing: -0.8, color: HF.ink }}>uClimb</span>
        <span style={{ width: 7, height: 7, background: HF.accent, display: 'inline-block', transform: 'translateY(-3px)' }} />
      </div>
...
function HFEventPost() {
  return (
    <div style={{ margin: '0 12px 16px', background: HF.paper2, border: `1px dashed ${HF.rule}`, borderRadius: 4, overflow: 'hidden' }}>

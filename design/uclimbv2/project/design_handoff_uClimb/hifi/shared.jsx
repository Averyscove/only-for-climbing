...
const HF_IMG = {
  ...
  mara:     'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&q=80',
  jules:    'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&q=80',
  ben:      'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&q=80',
  ari:      'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&q=80',
  tomo:     'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80',
  nat:      'https://images.unsplash.com/photo-1557555187-23d685287bc3?w=200&q=80',
  you:      'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=200&q=80',
  finn:     'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?w=200&q=80',
};
...
function HFTabBar({ active = 'home' }) {
  const items = [
    ...
    { id: 'crag', icon: HFIcon.flame, label: 'Crag' },
